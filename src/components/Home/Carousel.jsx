    ...
    return (
        <>
            ...
            <div className="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
                ...
                <button aria-label="Slide 1" className="" data-bs-slide-to="0" data-bs-target="#carouselExampleIndicators" type="button"></button>
                <button aria-label="Slide 2" data-bs-slide-to="1" data-bs-target="#carouselExampleIndicators" type="button" className=""></button>
                <button aria-label="Slide 3" data-bs-slide-to="2" data-bs-target="#carouselExampleIndicators" type="button" className="active" aria-current="true"></button>
                </div>
                ...
                <div className="carousel-item" data-bs-interval="3000">
                    ...
                    <div className="container-fluid containerframe remove-padding">
                        ...
                        <div className="col-md-6 mt-auto">
                            ...
                            <picture>
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_one.avif"
                                type="image/avif"
                                />
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_one.webp"
                                type="image/webp"
                                />
                                <img
                                alt="person"
                                className="img-fluid"
                                src="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_one.png"
                                width="600"
                                />
                            </picture>
                            </div>
                ...
                <div className="carousel-item" data-bs-interval="3000">
                    ...
                    <div className="container-fluid containerframe remove-padding">
                        ...
                        <div className="col-md-6 mt-auto">
                            ...
                            <picture>
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_three.avif"
                                type="image/avif"
                                />
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_three.webp"
                                type="image/webp"
                                />
                                <img
                                alt="expert"
                                ...
                                decoding="async"
                                loading="lazy"
                                src="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_three.png"
                                width="600"
                                />
                            </picture>
                            </div>
                ...
                <div className="carousel-item active" data-bs-interval="3000">
                    ...
                    <div className="container-fluid containerframe remove-padding">
                        ...
                        <div className="col-md-6 mt-auto">
                            ...
                            <picture>
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_two.avif"
                                type="image/avif"
                                />
                                <source
                                srcSet="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_two.webp"
                                type="image/webp"
                                />
                                <img
                                alt="doctor"
                                ...
                                decoding="async"
                                loading="lazy"
                                src="https://mrplin.sgp1.cdn.digitaloceanspaces.com/static/assests/home/version_two/banner_img_two.png"
                                width="500"
                                />
                            </picture>
                            </div>
